...
public class OneWaySearchActivity extends AppCompatActivity implements View.OnClickListener{
    private TextView oneWayHeader;
    private Switch userToggle;
    private boolean userToSchool;
    private TextView userToFromText;
    private TextView userDateText;
    private TextView userTimeText;
    private Button searchExecute_button;
    private Button pickDate_button;
    private Button pickTime_button;
    private EditText userZipEditText;
    private TextView tellUser_zip;
    private String weekDayTo, userGender, userStatus, userDisable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_way_search);
